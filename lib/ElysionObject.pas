...
private
  FName: String;      //< Private stored: Name of an object -> Access (read/write) through published properties (TelObject.Name)
  FNote: String;      //< Private stored: Note of an object -> Access (read/write) through published properties (TelObject.Note)
  FDrawable: Boolean; //< Private stored: Draw flag of an object -> Read-only
  FID: Integer;       //< Private stored: ID of an object -> Access (read/write) through published properties (TelObject.ID)
  FTag: Cardinal;     //< Private stored: Tag of an object -> Access (read/write) through published properties (TelObject.Tag)
