...
type
  ...
  {$ENDIF}
    ...
    function ContainsRect(aRect: TelRect): Boolean;
    {$ENDIF}
  end;


  {$IFDEF FPC}
  TelImageOffset = object
  {$ELSE}
 ...
 (* TelActionType = (atRotation, atAlpha, );
  TelActionEffect = (ae);

  TelAction = record

    case ActionType: TelActionType of
